...
public class socdist1Console {
	...
	public static void main(String[] args) throws IOException{
		out = new PrintWriter(System.out);//new FileWriter("socdist1.out"));
...
//		}
	...
	static class FastReader{
		...
		StringTokenizer st;
		public FastReader() {
			br = new BufferedReader(new InputStreamReader(System.in));//new FileReader("socdist1.in"));
		}
		String next() {
